 ...
 * pixel, every one of them a different number, the axis said $678M while bars
 * several times that were drawn the same length as it, and the panel grew a
 * horizontal scrollbar. A scale that only describes 25 of the 121 rows it is
