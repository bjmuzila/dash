 ...
 *   1. A reserved color means exactly one thing. Import the token, never
...
/* ── Text ─────────────────────────────────────────────────────────────────── */
// One color, optically corrected for three contexts. NOT a light/medium/dark
...
export const FLIP_MARK = "⚡︎"; // ⚡ + VS15. A bare bolt renders as an
                                         ...
                                         // color, which draws the flip in the
                                         // Volt's reserved color. Always this.
