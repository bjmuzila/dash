/**
 * The color vocabulary, drawn from the tokens rather than described. A member
 * learns these in the first session and then reads the whole product by color,
...
export default function Colors() {
  return (
    <PageShell
      ...
      lede={
        <>
          A color is a word in this product. Each reserved hex means exactly one thing, and a near-miss is
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <ul style={{ margin: 0, paddingLeft: 20, display: "grid", gap: 10, color: PAPER }}>
            <li>
              ...
              <span style={{ color: PAPER_QUIET }}>
                The reserved-color test fails the build on a hand-minted hex. Import the token.
              </span>
            </li>
            <li>
              ...
              <span style={{ color: PAPER_QUIET }}>
                ...
                paints it orange and discards your color, and orange is the Volt's reserved color: a bare
                bolt silently draws the flip in the Volt's color.
              </span>
            </li>
          </ul>
        </Card>
        ...
        <Card title="Surfaces and text" subtitle="Close together on purpose. Depth is a hairline and a shadow, not a jump in lightness.">
          ...
          <p style={{ margin: "14px 0 0", fontSize: 13, color: PAPER_QUIET, maxWidth: 640 }}>
            ...
            color, optically corrected for three contexts. Secondary information is expressed through size,
