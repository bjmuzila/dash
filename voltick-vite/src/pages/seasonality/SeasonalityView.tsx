...
// rgba() and the on-accent ink are Voltick tokens, pulled in because SHELL_CSS
// needs a wash and a filled pill and neither can be expressed as an inline style.
import { INK_ON_SURGE, rgba } from "../../theme";
...
.sea-railitem[aria-current="true"]{font-weight:800;color:${HOME_THEME.cyan};
  border-color:${rgba(HOME_THEME.cyan, 0.4)};
  background:linear-gradient(90deg,${rgba(HOME_THEME.cyan, 0.26)},${rgba(HOME_THEME.cyan, 0.04)})}
...
.sea-comparecta{margin-left:auto;flex:none;padding:5px 12px;border-radius:999px;
  background:${HOME_THEME.cyan};color:${INK_ON_SURGE};font-size:11px;font-weight:800;letter-spacing:.06em;
