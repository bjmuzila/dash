...
.pmk .cbchead h3{margin:0;font-size:var(--text-xs);letter-spacing:.09em;text-transform:uppercase;color:var(--txt);font-weight:600}
...
.pmk .cbcnote{font-size:11.5px;color:var(--txt);padding:10px 0}
...
.pmk .cbctbl th{padding:9px 13px;font-size:var(--text-2xs);font-weight:600;letter-spacing:.09em;text-transform:uppercase;
  color:var(--txt);text-align:left;white-space:nowrap;border-bottom:1px solid var(--line)}
...
/* Was opacity:.55 — a skipped row says so in words; it does not need to be
   greyed out to be understood, and grey type is what this panel was pulled
   up on (2026-09-10). Backgrounds may dim; type may not. */
.pmk .cbctbl tr.skip td{color:var(--txt)}
.pmk .cbctbl .r{text-align:right}
.pmk .cbctbl .dim{color:var(--txt)}
.pmk .cbctbl .dim2{color:var(--txt)}
.pmk .cbctbl .ck{font-weight:600;color:var(--txt)}
.pmk .cbctbl .up{color:var(--pos)}
.pmk .cbctbl .down{color:var(--neg)}
.pmk .cbctbl .at{margin-left:5px;font-size:10.5px;color:var(--txt)}
.pmk .cbctbl .pl{font-weight:700}
.pmk .cbctbl .pl.flat{color:var(--txt);font-weight:400}
...
.pmk .cbctbl .pl.live{opacity:1}
.pmk .cbctbl .pl .usd{margin-left:7px;font-size:10.5px;font-weight:600;color:var(--txt)}
...
.pmk .cbcchip.off{border-color:var(--line2);color:var(--txt)}
.pmk .cbcchip .cb{margin-left:6px;font-size:10.5px;font-weight:600;color:var(--txt)}

.pmk .cbcfoot{display:flex;gap:16px;flex-wrap:wrap;align-items:center;padding:8px 13px;
  border-top:1px solid var(--line);font-size:10.5px;color:var(--txt);
...
.pmk .cbcmhead .sub{font-size:var(--text-xs);color:var(--txt)}
.pmk .cbcmhead .x{margin-left:auto;font:inherit;font-size:var(--text-base);font-weight:700;line-height:1;cursor:pointer;
  background:transparent;border:1px solid var(--line2);color:var(--txt);border-radius:7px;padding:4px 11px}
...
.pmk .cbcbig .line{font-size:12px;color:var(--txt);margin-top:6px}
.pmk .cbcbig .line .t{color:var(--txt);font-size:9.5px;letter-spacing:.06em;text-transform:uppercase;margin-right:3px}
.pmk .cbcbig .line .ar{color:var(--txt);margin:0 6px}
...
.pmk .cbcstats .k{font-size:9.5px;font-weight:600;color:var(--txt);letter-spacing:.08em;text-transform:uppercase}
.pmk .cbcstats .v{font-size:12px;font-weight:700;color:var(--txt)}

.pmk .cbc .up{color:var(--pos)}
.pmk .cbc .down{color:var(--neg)}
.pmk .cbc .flat{color:var(--txt)}
...
.pmk .cbctgl{font:inherit;font-size:var(--text-xs);font-weight:600;padding:5px 12px;border-radius:7px;cursor:pointer;
  letter-spacing:.06em;text-transform:uppercase;background:transparent;border:1px solid var(--line2);color:var(--txt)}
...
.pmk .cbcskip{padding:24px 20px;text-align:center;border:1px dashed var(--line2);border-radius:var(--r2);line-height:1.7;
  font-family:ui-monospace,"SF Mono",Menlo,Consolas,monospace;font-size:11.5px;color:var(--txt)}
.pmk .cbcskip .t{font-size:12px;font-weight:700;color:var(--amber);margin-bottom:5px;font-family:inherit}
.pmk .cbcskip .sub{margin-top:7px;color:var(--txt)}

.pmk .cbcsvg{width:100%;height:auto;display:block}
.pmk .cbchint{font-size:10.5px;color:var(--txt);letter-spacing:.04em}
