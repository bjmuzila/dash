            ...
            <div className="sc" key={g.key}>
              <div className="nm">
                ...
                <span className={`pill${g.tone === "ok" ? " cool" : g.tone === "bad" ? " hot" : g.tone === "warn" ? " warn" : ""}`}
                  style={g.tone === "vio" ? { borderColor: "color-mix(in srgb, var(--color-violet) 45%, transparent)", color: "var(--violet)", background: "color-mix(in srgb, var(--color-violet) 9%, transparent)" } : undefined}>
                  {g.status}
                </span>
              </div>
