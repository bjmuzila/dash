// Pricing apology + refund/credit email to current subscribers. Owner is walking back
// the original pricing, committing to charge close to cost (vs. $199–$699/mo elsewhere),
// and offering a partial refund or a cheaper next month while the official plan is
// finalized. Same brand shell as the other emails.
//
...
export interface PricingApologyOpts {
...
export const PRICING_APOLOGY_SUBJECT = "An apology, and a change to how we price CB Edge";
...
/** Plain-text fallback. */
export function pricingApologyText(opts: PricingApologyOpts = {}): string {
  const cta = opts.ctaUrl || SIGN_IN_URL;
  return [
    "Hi there,",
    "",
    "I want to be straight with you about pricing.",
    "",
    "I've decided not to charge much more than what it actually costs to run this dashboard. Every trader should be able to have access to a platform like this — not just the people who can afford the $199 or $699 a month that other tools charge.",
    "",
    "That means some of you paid more than you should have to get started. I'm working on a deal right now — a partial refund, or a cheaper rate on your next month — to make that right.",
    "",
    "The official plan will be out in the next few days, and I'll follow up with the specifics for your account as soon as it's ready.",
    "",
    `In the meantime, the dashboard is right here: ${cta}`,
    "",
    "Thank you for being early, and for your patience while I get the pricing right.",
    "",
...
/** Branded HTML pricing apology email. */
export function pricingApologyEmail(opts: PricingApologyOpts = {}): string {
...
<title>${escapeHtml(PRICING_APOLOGY_SUBJECT)}</title>
</head>
<body style="margin:0;padding:0;background:#05060A;">
  <!-- preheader (hidden) -->
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;">We're changing how we price CB Edge — and making it right for early members.</div>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:#0D1119;border:1px solid rgba(255,255,255,0.10);border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td align="center" style="padding:0 32px 4px 32px;">
              <div style="font:800 23px/1.3 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#ffffff;">An apology, and a change in pricing</div>
              <div style="font:600 13px/1.4 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#8ECAE6;margin-top:6px;">I want to make this right for you.</div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:20px 32px 4px 32px;">
              ...
              <p style="margin:0 0 14px 0;font:400 14px/1.7 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#d4dde6;">
                I've decided not to charge much more than what it actually costs to run this dashboard. Every trader should be able to have access to a platform like this — not just the people who can afford the <strong style="color:#8ECAE6;">$199 or $699 a month</strong> that other tools charge.
              </p>
            </td>
          </tr>

          <!-- making-it-right callout -->
          <tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid rgba(33,158,188,0.30);border-radius:12px;background:linear-gradient(180deg,rgba(33,158,188,0.10),rgba(33,158,188,0.02));">
                <tr>
                  <td style="padding:18px 20px;">
                    <div style="font:700 11px/1 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;letter-spacing:0.12em;text-transform:uppercase;color:#8ECAE6;">Making it right</div>
                    <div style="font:400 14px/1.6 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#d4dde6;margin-top:8px;">
                      Since you got in before this change, some of you paid more than you should have. I'm working on a deal right now — a <strong style="color:#ffffff;">partial refund</strong>, or a <strong style="color:#ffffff;">cheaper rate on your next month</strong> — to make that right.
                    </div>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:14px 32px 4px 32px;">
              <p style="margin:0;font:400 14px/1.7 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#d4dde6;">
                The official plan will be out in the <strong style="color:#8ECAE6;">next few days</strong>, and I'll follow up with the specifics for your account as soon as it's ready.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 32px 28px 32px;">
              <div style="border-top:1px solid rgba(255,255,255,0.08);padding-top:18px;font:400 13px/1.7 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#9fb3c8;">
                Thank you for being early, and for your patience while I get the pricing right.<br><br>
