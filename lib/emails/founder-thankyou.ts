...
const DOCS_URL = "https://www.cbedge.net/docs";
...
export function founderThankYouText(opts: FounderThankYouOpts = {}): string {
  ...
  return [
    ...
    "",
    `New here? The docs walk you through every page: ${DOCS_URL}`,
    "",
    "One more thing — come join us in the Bzila Hangout Discord. This invite unlocks the CB Edge chat.",
    "",
    `Join the Discord: ${DISCORD_URL}`,
    "",
    "Your feedback genuinely shapes what gets built next — there's a Feedback page right inside the app, and I read every single note.",
    "",
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:#0D1119;border:1px solid rgba(255,255,255,0.10);border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td align="center" style="padding:20px 32px 24px 32px;">
              ...
              <div style="font:400 13px/1.6 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#9fb3c8;margin-top:14px;">
                New here? The <a href="${DOCS_URL}" style="color:#8ECAE6;text-decoration:underline;font-weight:600;">docs</a> walk you through every page.
              </div>
            </td>
          </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid rgba(33,158,188,0.30);border-radius:12px;background:linear-gradient(180deg,rgba(33,158,188,0.10),rgba(33,158,188,0.02));">
                <tr>
                  <td align="center" style="padding:20px;">
                    <div style="font:700 11px/1 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;letter-spacing:0.12em;text-transform:uppercase;color:#8ECAE6;">Join the community</div>
                    <div style="font:400 14px/1.6 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#d4dde6;margin-top:8px;">
                      Come hang out in the <strong style="color:#219EBC;">Bzila Hangout</strong> Discord. This invite unlocks the <strong style="color:#ffffff;">CB Edge</strong> chat.
                    </div>
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:16px auto 0 auto;">
                      <tr>
                        <td align="center" style="border-radius:10px;border:1px solid #219EBC;">
                          <a href="${DISCORD_URL}" style="display:inline-block;padding:11px 26px;font:700 14px/1 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#8ECAE6;text-decoration:none;border-radius:10px;">Join the Discord →</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="padding:0 32px 28px 32px;">
              <div style="border-top:1px solid rgba(255,255,255,0.08);padding-top:18px;font:400 13px/1.7 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#9fb3c8;">
                Your feedback genuinely shapes what gets built next — there's a <strong style="color:#8ECAE6;">Feedback</strong> page right inside the app, and I read every single note.<br><br>
          ...
          <tr>
            <td align="center" style="padding:18px 32px;">
              <div style="font:400 11px/1.6 -apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#6b7d8f;">
                CB Edge · You're receiving this because you signed up.<br>
                <a href="${unsubHref}" style="color:#8ECAE6;text-decoration:underline;">Unsubscribe</a>
                &nbsp;·&nbsp;
                <a href="${DOCS_URL}" style="color:#6b7d8f;text-decoration:underline;">Docs</a>
                &nbsp;·&nbsp;
