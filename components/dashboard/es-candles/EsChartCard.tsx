...
import {
  BUBBLE_STYLE, BUBBLE_REF_FLOOR_FRAC, BUBBLE_LEVELS_RANGE, BUBBLE_INTENSITY_RANGE,
...
export default function EsChartCard({
  ...
  // The two bubble controls that survived the slider purge (see slotStore for
  ...
  // Everything about SIZE is frozen in BUBBLE_STYLE; neither of these touches it.
  ...
  }, [showHeatmap, showGexBubbles, bubbleMins, bubbleLevels, bubbleIntensity, intensity, gexMetric, rows, interval, showProfile, profile, showTpo, tpoProfiles, showLevels, showFlipCross, mvcHistory, showCb, bb, weeklyEm]);
        ...
        <Dock className="dock-noscroll" noScroll fullWidth style={{ minWidth: 0 }}>
          ...
          {ovlOpen && ovlRect && createPortal(
            ...
            >
              ...
              {showGexBubbles && (
                <div style={{ marginTop: 7, paddingTop: 8, borderTop: `1px solid ${HOME_THEME.border}` }}>
                  {/* Two sliders, not seven. Contrast / Size / Max / Curve /
                      ...
                      These two are QUESTIONS — how much of the board do you want
                      on screen, and how loud should it sit against the candles —
                      and questions have no correct answer to hardcode.

                      Neither touches SIZE. Radius stays straight proportional to
                      |net GEX| whatever these are set to, so a wall is never
                      bigger because you asked for more rows. */}
