...
// The data layer lives in hooks/useEmLookup — it was defined here until the
// phone EM view needed the same alias fan-out, win-rate merge and zones
// fallback. One copy, two views.
import { POPULAR, fmtUpdated, useEmLookup, val } from "@/hooks/useEmLookup";
