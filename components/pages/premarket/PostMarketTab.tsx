...
type Col = { ts: number; spot: number; cells: { strike: number; net: number }[] };
type RawCol = { slotTs: number; spot?: number; cells: Array<{ strike: number; net: number }> };
type HistState = "loading" | "ok" | "empty" | "error";
 ...
 */
function structureFromChain(items: unknown[], expDate: string, spot: number): NextStructure | null {
...
function useNextExpiryStructure(enabled: boolean, todayExpiry: string, spot: number) {
