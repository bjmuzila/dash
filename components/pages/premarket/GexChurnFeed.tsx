...
import { buildShareColor, heatFill, type GexGrossRow } from "@/components/shared/GexHeatBar";
...
.gcf .gcf-tag{font-size:9.5px;font-weight:800;letter-spacing:.09em;padding:1px 5px;border-radius:4px;
  color:var(--muted);border:1px solid rgba(255,255,255,.16)}
.gcf .gcf-l2{display:flex;gap:9px;align-items:center;flex-wrap:wrap;font-size:11px;color:var(--muted);
  font-variant-numeric:tabular-nums}
.gcf .gcf-bar{flex:0 1 150px;height:6px;border-radius:4px;background:rgba(255,255,255,.07);overflow:hidden}
.gcf .gcf-bar.prov{background-image:repeating-linear-gradient(135deg,rgba(255,255,255,.05) 0 4px,transparent 4px 8px)}
