...
export default function Premarket() {
  ...
  // frozen NVDA chain for last Tuesday — but `HistoricalRecap` has taken a
  // `symbol` prop since 2026-08-27 and reads that symbol's OWN recorded stores
  // (settled per-day levels, its wall log, its per-minute ladder). Those go
  // back for every MAIN name.
  //
   ...
   * to SPX. See the snap-back effect above.
   */
