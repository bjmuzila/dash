...
/**
 * "Set a 4-digit PIN" — offered once per device, right after the welcome
 * splash, and available forever after in Settings.
 *
 * It is an OFFER, not a gate. Skipping costs nothing: the account still works
 * exactly as it did, on the password. Anything that stands between someone and
