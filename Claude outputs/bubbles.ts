...
export function drawBubbles(
  ...
  // there is.
  //
  // (2026-09-09: briefly replaced by the caller passing its own bucket in. That
  // was a guess at the replay jitter and it was the wrong one — the jitter was
  // the axis lock fighting the time scale, see chart.ts setAxisLock — so this is
  // back to the estimate that had been correct for months. Do not re-do it
  // without a measurement showing the median actually moves.)
  const diffs: number[] = []
