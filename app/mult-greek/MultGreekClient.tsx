...
import { HEAT_SKINS, isHeatSkin, skinMetricBg, skinRankBg, levelFillBg, type HeatSkin, type SkinDef } from "@/lib/calculations/heatSkins";
 ...
 *
 * The table itself now lives in lib/calculations/heatSkins, because the option
 * chain grid paints on the SAME skins: "vivid on the chain" has to mean the
 * identical ramp, rank floors and level fill this ladder uses, and two copies
 * of those numbers is how two pages end up showing two different pictures of
 * the same gamma. Re-exported here so nothing that imported HeatSkin /
 * HEAT_SKINS from this file has to change.
 * ─────────────────────────────────────────────────────────────────────────── */
export type { HeatSkin, SkinDef };
export { HEAT_SKINS };
 ...
 *
 * The ramp itself lives in lib/calculations/heatSkins (skinMetricBg) so the
 * option chain grid paints on the identical curve; this alias keeps the call
