  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6 }}>
        ...
        <button onClick={onDelete} style={{ background: "none", border: "none", color: HOME_THEME.muted, cursor: "pointer", fontSize: 14, padding: 0 }}>x</button>
      </div>
  ...
  return (
    <div style={homeShellStyle}>
      <div style={homeHeaderStyle}>
        <div style={{ fontSize: 11, fontWeight: 700, color: HOME_THEME.cyan, letterSpacing: ".15em", textTransform: "uppercase" }}>
          Personal Logs
        </div>
      ...
      <div style={homeContentStyle}>
        <div style={{ ...homePanelStyle, flex: 1, minHeight: 0, padding: 20 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: 0, overflow: "hidden", gap: 20, height: "100%" }}>
            <Column
