...
function StatCard({
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
        {label}
      </div>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text, letterSpacing: "0.01em", marginBottom: 8 }}>
      {children}
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        <div style={{ fontSize: 18, fontWeight: 700, color }}>SPX Index Feed · {label}</div>
    ...
    <div style={{ ...homePanelStyle, overflow: "visible", background: "transparent" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
          ...
          <span style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text, letterSpacing: "0.01em", whiteSpace: "nowrap" }}>
            {title}
          </span>
          {subtitle != null && (
            <span style={{ fontSize: 12, fontFamily: "var(--font-mono)", color: HOME_THEME.text, opacity: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              {subtitle}
            </span>
          )}
        </div>
...
function LineChartCard({
  ...
  return (
    <div style={{ ...homePanelStyle, padding: "16px 18px", display: "flex", flexDirection: "column", gap: 10, minWidth: 0 }}>
      <div>
        <div style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text }}>{title}</div>
        <div style={{ fontSize: 12, fontWeight: 700, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em", marginTop: 2 }}>{subtitle}</div>
      </div>
      ...
      {hover != null && ptsA[hover] && (
        ...
        >
          ...
          <div style={{ fontSize: 14, fontWeight: 500, color: HOME_THEME.text, fontFamily: "var(--font-mono)" }}>
            {ptsA[hover].v.toLocaleString()} <span style={{ fontSize: 9, fontWeight: 700, color: HOME_THEME.text, opacity: 1 }}>visits</span>
          </div>
        </div>
      )}
      </div>
      <div style={{ display: "flex", gap: 16, fontSize: 12, color: HOME_THEME.text, opacity: 1, fontWeight: 700 }}>
...
function BigMetricCard({ label, value, delta, accent }: { label: string; value: string; delta: string; accent: string }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em" }}>{label}</div>
      <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
        <span style={{ fontSize: 30, fontWeight: 500, color: HOME_THEME.text, lineHeight: 1 }}>{value}</span>
        {delta ? <span style={{ fontSize: 12, fontWeight: 500, color: `${HOME_THEME.text}` }}>{delta}</span> : null}
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ ...homePanelStyle, padding: "12px 14px", display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
      ...
      <div style={{ minWidth: 0, flex: 1 }}>
        <div style={{ fontSize: 12, fontWeight: 400, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{label}</div>
      </div>
      <div style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text, fontFamily: "var(--font-mono)", flexShrink: 0 }}>{value}</div>
    </div>
  );
}
  ...
  return (
    <div style={{ ...homePanelStyle, padding: "10px 12px", display: "flex", alignItems: "center", gap: 11, minWidth: 0 }}>
      ...
      <div style={{ minWidth: 0, flex: 1 }}>
        ...
        <div style={{ fontSize: 12, color: HOME_THEME.text, opacity: 1, fontFamily: "var(--font-mono)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{time} · {who}</div>
      </div>
      {status && (
  ...
  return (
    <div style={{ ...homePanelStyle, overflow: "hidden" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderBottom: `1px solid ${HOME_THEME.border}`, background: "rgba(13,17,25,0.60)" }}>
        ...
        <span style={{ fontSize: 18, fontWeight: 600, color: HOME_THEME.text, letterSpacing: "0.01em" }}>{label}</span>
...
function OverviewSection({ metrics }: {
  ...
  const titleStyle: React.CSSProperties = { fontSize: 18, fontWeight: 700, color: HOME_THEME.cyan, marginBottom: 11 };
  ...
  const OpsRow = ({ label, children, last }: { label: string; children: React.ReactNode; last?: boolean }) => (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 13, padding: "10px 0", borderBottom: last ? "none" : `0.5px solid ${HOME_THEME.border}`, color: HOME_THEME.text }}>
      <span>{label}</span>
      <span style={{ fontSize: 13, fontWeight: 500, fontFamily: "var(--font-mono)" }}>{children}</span>
    </div>
  );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2, minmax(0,1fr))" : "repeat(6, minmax(0,1fr))", gap: 10 }}>
        {[
          ...
          <div key={k.l} style={{ ...homePanelStyle, padding: "11px 13px" }}>
            <div style={{ fontSize: 18, fontWeight: 600, color: HOME_THEME.text, opacity: 1, marginBottom: 6, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{k.l}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "minmax(0,1fr)" : "repeat(3, minmax(0,1fr))", gap: 10 }}>
        <div style={cardStyle} title="Total page loads per day across the site for the last 12 days (ET day buckets). The % is the change from the first day in the window to the most recent.">
          ...
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, marginTop: 9, color: HOME_THEME.text, opacity: 1 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "minmax(0,1fr)" : "1fr 1fr", gap: 10 }}>
        <div style={cardStyle}>
          ...
          {topPages.length === 0
            ? <div style={{ fontSize: 12, color: HOME_THEME.text, opacity: 1 }}>No page loads recorded yet.</div>
      ...
      <div style={cardStyle}>
        <div style={{ ...titleStyle, display: "flex", justifyContent: "space-between" }}>
          ...
          <span style={{ fontSize: 12, color: HOME_THEME.text, opacity: 1, fontFamily: "var(--font-mono)" }}>sample</span>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "32px repeat(24, 1fr)", gap: 2 }}>
          ...
          {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((d, di) => (
            <Fragment key={d}>
              <div style={{ fontSize: 12, color: HOME_THEME.text, opacity: 1, lineHeight: "30px" }}>{d}</div>
              {Array.from({ length: 24 }, (_, h) => {
  ...
  const SidebarContent = () => (
    <>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 18, fontWeight: 600, color: HOME_THEME.text, letterSpacing: "0.02em" }}>CB Edge</div>
          <div style={{ fontSize: 17, color: `${HOME_THEME.cyan}cc`, letterSpacing: "0.08em", marginTop: 2 }}>OWNER DASHBOARD</div>
        </div>
        {isMobile && (
          <button
        ...
        {STATUS_ROWS.map((row) => (
          <div key={row.label} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "5px 0" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: 17, color: HOME_THEME.text }}>{row.label}</span>
            </div>
            {row.sub && <span style={{ fontSize: 17, color: HOME_THEME.text, opacity: 1, fontFamily: "var(--font-mono)" }}>{row.sub}</span>}
          </div>
        ))}
      </div>
      ...
      <nav style={{ flex: 1, overflowY: "auto", padding: "8px 8px", display: "flex", flexDirection: "column", gap: 2 }}>
        <div style={{ fontSize: 18, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.12em", textTransform: "uppercase", padding: "4px 8px 6px" }}>SECTIONS</div>
        {NAV_ITEMS.map((item) => {
      ...
      <div style={{ padding: "10px 8px 14px", borderTop: `1px solid ${HOME_THEME.border}`, display: "flex", flexDirection: "column", gap: 4 }}>
        <div style={{ fontSize: 18, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.12em", textTransform: "uppercase", padding: "0 8px 4px" }}>QUICK CONTROLS</div>
        {[
          ...
          <button
            ...
            style={{
              ...
              fontSize: 17, cursor: ctlBusy === key ? "wait" : "pointer",
              fontFamily: "inherit",
        ...
        {ctlMsg && (
          <div style={{
            fontSize: 12, fontFamily: "var(--font-mono)", padding: "5px 8px", borderRadius: 6, marginTop: 2,
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, overflow: "hidden" }}>
        ...
        <div style={{ ...homeHeaderStyle, padding: isMobile ? "10px 12px" : "10px 18px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 500, color: HOME_THEME.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              {isMobile ? "Owner" : (NAV_ITEMS.find(n => n.id === ownerTab)?.label ?? "Overview")}
            </div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            {lastRefresh && !isMobile && (
              <span style={{ fontSize: 17, color: `${HOME_THEME.text}`, fontFamily: "var(--font-mono)" }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <label style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 17, color: HOME_THEME.text, cursor: "pointer" }}>
                <input
                  type="checkbox"
            ...
            {(() => {
              ...
              if (visible.length === 0) {
                return <span style={{ fontSize: 17, color: HOME_THEME.text, opacity: 1 }}>No feedback yet.</span>;
              }
                  ...
                  >
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8, marginBottom: 6 }}>
                        ...
                        <span style={{ fontSize: 17, color: HOME_THEME.text, opacity: 1 }}>
                      ...
                      <div style={{ fontSize: 17, color: HOME_THEME.text, whiteSpace: "pre-wrap", wordBreak: "break-word" }}>
                        {f.message}
                      </div>
                    </div>
                    <button
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
            <div style={{ fontSize: 17, color: HOME_THEME.text, opacity: 1, fontWeight: 400, letterSpacing: "0.01em" }}>Window</div>
          ...
          <div style={{ marginTop: 12 }}>
            <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 6, flexWrap: "wrap", gap: 6 }}>
              <div style={{ fontSize: 17, fontWeight: 500, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em" }}>
                /ws/gex Outbound · Live (last 60s)
              </div>
              <div style={{ fontSize: 17, fontFamily: "var(--font-mono)", color: HOME_THEME.text, opacity: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              <button
                ...
                style={{ ...homeButtonStyle, padding: "7px 16px", borderRadius: 8, fontSize: 12, opacity: ctlBusy === "reconnect" ? 0.6 : 1, cursor: ctlBusy === "reconnect" ? "wait" : "pointer" }}
              >
              ...
              <button
                ...
                style={{ ...homeButtonStyle, padding: "7px 16px", borderRadius: 8, fontSize: 12, opacity: ctlBusy === "eod" ? 0.6 : 1, cursor: ctlBusy === "eod" ? "wait" : "pointer" }}
              >
              ...
              <button
                ...
                style={{ ...homeButtonStyle, padding: "7px 16px", borderRadius: 8, fontSize: 12, opacity: ctlBusy === "mvcSnap" ? 0.6 : 1, cursor: ctlBusy === "mvcSnap" ? "wait" : "pointer" }}
              >
              ...
              <button
                ...
                style={{ ...homeButtonStyle, padding: "7px 16px", borderRadius: 8, fontSize: 12, opacity: ctlBusy === "premarket" ? 0.6 : 1, cursor: ctlBusy === "premarket" ? "wait" : "pointer" }}
              >
              ...
              <button
                ...
                style={{ ...homeButtonStyle, padding: "7px 16px", borderRadius: 8, fontSize: 12, opacity: ctlBusy === "strategy" ? 0.6 : 1, cursor: ctlBusy === "strategy" ? "wait" : "pointer" }}
              >
              ...
              <button
                ...
                style={{ ...homeButtonStyle, padding: "7px 16px", borderRadius: 8, fontSize: 12, opacity: ctlBusy === "clearChat" ? 0.6 : 1, cursor: ctlBusy === "clearChat" ? "wait" : "pointer" }}
              >
          ...
          {!levelsCollapsed && <div style={{ padding: "16px 18px", display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 600, color: HOME_THEME.text, fontFamily: "var(--font-mono)" }}>Sat ~09:00 ET</span>
              </div>
              <button
            ...
            {!pubRun.running && pubRun.failedEm.length > 0 && (
              <div style={{ fontSize: 12, color: HOME_THEME.orange, lineHeight: 1.6 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                  ...
                  <button
                    ...
                    style={{
                      fontSize: 12, fontWeight: 500, padding: "3px 10px", borderRadius: 6, cursor: (retrying || publishing) ? "default" : "pointer",
            ...
            {levels.tickers.length > 0 && (
              <>
                {levels.tickers.some((t) => t.stale) && (
                  <div style={{ fontSize: 12, fontWeight: 700, color: HOME_THEME.orange, display: "flex", alignItems: "center", gap: 6 }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {clerk == null ? (
              <span style={{ fontSize: 17, color: HOME_THEME.text, fontFamily: "var(--font-mono)" }}>Loading…</span>
            ) : (
              <>
              {/* Key status row */}
              <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 14 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                  ...
                  <span style={{ fontSize: 12, fontFamily: "var(--font-mono)", color: clerk.configured ? HOME_THEME.green : HOME_THEME.red }}>
              ...
              {(() => {
                ...
                if (!hasStats) {
                  ...
                  if (clerk.statsError) {
                    return (
                      <div style={{ fontSize: 17, color: HOME_THEME.orange, fontFamily: "var(--font-mono)" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12, borderTop: `1px solid ${HOME_THEME.border}`, paddingTop: 12 }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 12px", borderRadius: 8, background: `${HOME_THEME.cyan}14`, border: `1px solid ${HOME_THEME.cyan}33` }}>
                        <span style={{ fontSize: 12, fontWeight: 400, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em" }}>Users</span>
                        <span style={{ fontSize: 22, fontWeight: 500, color: HOME_THEME.cyan, fontFamily: "var(--font-mono)" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 12px", borderRadius: 8, background: `${HOME_THEME.green}14`, border: `1px solid ${HOME_THEME.green}33` }}>
                        <span style={{ fontSize: 12, fontWeight: 400, color: HOME_THEME.text, opacity: 1, letterSpacing: "0.01em" }}>Active sessions</span>
                        <span style={{ fontSize: 22, fontWeight: 500, color: HOME_THEME.green, fontFamily: "var(--font-mono)" }}>
                      ...
                      <div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          {s!.recent.map((u, i) => (
                            ...
                            >
                              <span style={{ fontSize: 17, color: HOME_THEME.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", minWidth: 0, flex: 1 }}>
        ...
        <div style={{ ...homePanelStyle }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ fontSize: 17, fontFamily: "var(--font-mono)", color: HOME_THEME.text, opacity: 1 }}>
          ...
          <div style={{ padding: "14px", display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 14, fontSize: 17, color: HOME_THEME.text, opacity: 1 }}>
              ...
              <span style={{ marginLeft: "auto", fontStyle: "italic", fontSize: 17 }}>
            ...
            <div style={{ ...homePanelStyle, overflow: "hidden" }}>
              <div style={{
                ...
                <span style={{ fontSize: 18, fontWeight: 600, color: HOME_THEME.text, letterSpacing: "0.01em" }}>
                  Recent Activity
                </span>
                <span style={{ fontSize: 17, color: HOME_THEME.text, opacity: 1, marginLeft: "auto", fontFamily: "var(--font-mono)" }}>
                  newest first
                </span>
              </div>
              <div style={{ maxHeight: 200, overflowY: "auto", scrollbarWidth: "thin" }}>
                {feed.length === 0 ? (
                  <div style={{ padding: "12px 14px", fontSize: 17, color: HOME_THEME.text, opacity: 1 }}>
                      ...
                      return (
                        ...
                        >
                          <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
                            ...
                            <span style={{ fontSize: 17, fontWeight: 600, color: HOME_THEME.text, opacity: active ? 1 : 0.7, whiteSpace: "nowrap" }}>{item.label}</span>
                          </div>
                          <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                            ...
                            {status ? (
                              ...
                              <span style={{ fontSize: 17, color: HOME_THEME.red, opacity: 1 }}>never visited</span>
                            )}
                            {seen && (
