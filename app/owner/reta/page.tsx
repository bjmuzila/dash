...
import { HOME_THEME, SOFT_RED, homeInputStyle, statTileStyle } from "@/components/shared/homeTheme";
...
const PEOPLE: { key: PersonKey; label: string; color: string }[] = [
  { key: "brandon", label: "Brandon", color: HOME_THEME.cyan },
  { key: "heather", label: "Heather", color: HOME_THEME.orange },
];
...
export default function RetaPage() {
  ...
  return (
    <PageShell>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(170px, 1fr))", gap: 12 }}>
        ...
        {summary.map((s) => (
          <Stat
            ...
            accent={s.change != null && s.change < 0 ? HOME_THEME.green : HOME_THEME.text}
          />
        ))}
        {summary.map((s) => (
          <Stat
      ...
      {/* ── calculator ── */}
      <Card variant="budget" padding={0} style={{ overflow: "hidden" }}>
        <div style={{ display: "grid", gridTemplateColumns: "minmax(320px, 1fr) minmax(320px, 1fr)", gap: 0 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-end", gap: 14 }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: HOME_THEME.bg,
                  background: `linear-gradient(180deg, ${HOME_THEME.green}, ${HOME_THEME.cyan})`,
                  border: "none",
          ...
          <div style={{ padding: 22, background: rgba(HOME_THEME.cyan, 0.03) }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              <span
                style={{
                  ...
                  border: `1px solid ${rgba(HOME_THEME.green, 0.4)}`,
                  background: rgba(HOME_THEME.green, 0.1),
                }}
              >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 10 }}>
              <Stat label="Concentration" value={`${num(conc)}`} sub="mg / mL" accent={HOME_THEME.green} />
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: "10px 14px",
                    borderRadius: 10,
                    border: `1px solid ${current ? rgba(HOME_THEME.green, 0.4) : HOME_THEME.border}`,
                    background: current ? rgba(HOME_THEME.green, 0.07) : "rgba(255,255,255,0.02)",
                  }}
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 800, color: HOME_THEME.green }}>{num(c)} mg/mL</span>
                    <span style={{ fontSize: 11, color: rgba(HOME_THEME.text, 0.45) }}>{s.syringe_units}u syringe</span>
                    {current && (
                      <span style={{ ...LABEL, fontSize: 9, color: HOME_THEME.green }}>in force</span>
                    )}
                  </div>
                  <button
                    type="button"
                    ...
                    >
                      ...
                      <td
                        style={{
                          ...CELL,
                          textAlign: "right",
                          color: c > 0 ? HOME_THEME.green : rgba(HOME_THEME.text, 0.3),
                          fontVariantNumeric: "tabular-nums",
                        }}
                      >
                        {c > 0 ? num(c) : "—"}
