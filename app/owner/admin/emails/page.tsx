    ...
    <PageShell maxWidth={680} align="center">
      <Card accent="cyan">
        <div style={{ marginBottom: 20 }}>
          <div style={{ fontSize: 20, fontWeight: 800, letterSpacing: "0.02em" }}>📧 Email Broadcast</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {presets.map((p) => (
                  <DockButton
                    ...
                    style={{ height: 32, padding: "0 14px", fontSize: 13, opacity: loadingPreset === p.id ? 0.6 : 1 }}
                  >
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: HOME_THEME.muted, marginTop: 6, display: "flex", alignItems: "center", gap: 8 }}>
              <span>
      ...
      <Card accent="cyan" style={{ marginTop: 18 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          ...
          <button
            ...
            style={{ background: "none", border: "none", color: (historyRefreshStyle.color as string) ?? HOME_THEME.cyan, fontSize: 13, cursor: "pointer", textDecoration: "underline", padding: 0 }}
          >
            {historyRefreshLabel}
          </button>
        </div>
            ...
            {history.map((h) => (
              ...
              >
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 13, color: HOME_THEME.green, marginTop: 2 }}>
