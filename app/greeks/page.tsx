    ...
    >
      ...
      {hover && (
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 800, fontFamily: "var(--font-mono)", color: hover.value >= 0 ? "#00e676" : "#ff5252" }}>
            {fmt(hover.value)}
          </div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center", color: accent, fontWeight: 800, fontSize: 17,
          }}>{icon}</div>
          <div>
            <div style={{ fontSize: 17, fontWeight: 800, color: "#eef7ff", letterSpacing: ".04em" }}>{label}</div>
