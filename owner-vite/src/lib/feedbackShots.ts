 ...
 *
 * MIRROR: this is the owner-vite copy of components/shared/feedbackShots.ts —
 * owner-vite has no '@/components' alias and builds separately. The two files
 * are identical apart from this note. Change one, change the other.
 */
