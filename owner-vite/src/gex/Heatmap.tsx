...
// Ported into owner-vite standalone: DualTickerGex structural type inlined
// (sideGex/SPY-QQQ columns are optional and unused in the social-media capture).
type DualTickerGex = { SPY?: { map: Record<number, { netGEX: number }> }; QQQ?: { map: Record<number, { netGEX: number }> } }
